...
<html lang="en" data-bs-theme="auto">
    <head>
        ...
        <link href="{{ url('assets/dist/css/headers.css') }}" rel="stylesheet">
                ...
                <div class="container">
                    <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
                        ...
                        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                            ...
                            <li><a href="{{ route('task.index') }}" class="nav-link px-2 link-body-emphasis">Tarefas</a></li>
                            <li><a href="{{ route('user.index') }}" class="nav-link px-2 link-body-emphasis">Usuários</a></li>
                        </ul>
